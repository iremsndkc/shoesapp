  ...
  return (
    <header
      className="mb-6 xl:mb-20 md:mb-10 lg:mb-15 flex justify-between items-center
       bg-white-fa p-4 md:p-5 lg:p-6 xl:p-8 text-gray-dark rounded-[12px] md:rounded-[16px] lg:rounded-[20px] 
     xl:rounded-[24px] "
    >
      ...
      <Link to="/" className="w-[16%] max-w-[128px] max-h-[32px]">
        <img className="size-full" src="Group.svg" />
      </Link>
      ...
      <div className="flex items-center gap-5 lg:gap-10">
        ...
        <span
          className="size-[25px] md:size-[30px] lg:size-[40px] 
           bg-yellow rounded-full grid place-items-center 
